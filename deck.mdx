...
<Head>
  <title>CSS Custom Properties - UI Meetup - 9th Nov 2020</title>
...
<Text padding={50} center={false} content="What if we want to change the background color to 'papayawhip'?" />
...
<Text>
There must be an easier way to do this. Something on the lines of extracting the color into a variable and change it there to change it everywhere?
</Text>
...
<iframe height="422" style="width: 100%;" scrolling="no" title="Theming a site with CSS Custom Properties" src="https://codepen.io/chriscoyier/embed/ybgNKP?height=422&theme-id=dark&default-tab=css,result" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href='https://codepen.io/chriscoyier/pen/ybgNKP'>Theming a site with CSS Custom Properties</a> by Chris Coyier 
...
<img style={{maxHeight: '80%', marginTop: -50, marginBottom: -70}} src={compatibility} alt="Browser Compatibility Chart" />
